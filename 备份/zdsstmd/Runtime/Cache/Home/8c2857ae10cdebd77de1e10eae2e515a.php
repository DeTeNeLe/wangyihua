...
<body>
    ...
    <b><?php echo (session('adminuser')); ?>，欢迎使用信息管理系统</b><a href="/Yshclbssb.php/Home/Index/adminlist">帐号设置</a>
	&nbsp;|&nbsp;<a onclick="confirm('确定要处理预约挂单？数据备份了吗？数据备份了吗？数据备份了吗？')?location.href='/Yshclbssb.php/Home/Index/yuyue_all':''" href="javascript:;">预约挂单处理</a>
	&nbsp;|&nbsp;<a onclick="confirm('确定要进场短信通知？')?location.href='/Yshclbssb.php/Home/Index/getin_sms':''" href="javascript:;">进场短信通知[<?php echo getin_sms_count();?>]</a>   </div>
    ...
    <div class="uimakerinfo"><b>管理公告</b>--------------<strong>源码销售认准qq2994682708</strong></div>
    
    <ul class="umlist">
    <li><small>系统开关:<?php if($zt["zt"] == '0'): ?><a href="/Yshclbssb.php/Home/Index/gb">关闭系统</a>
      <?php else: ?><a href="/Yshclbssb.php/Home/Index/kq">开启系统</a><?php endif; ?><br />
