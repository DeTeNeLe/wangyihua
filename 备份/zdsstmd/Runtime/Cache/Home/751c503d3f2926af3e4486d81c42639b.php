...
<script type="text/javascript" src='/plupload/jquery.ui.plupload/jquery.ui.plupload.min.js'></script>
...
<body>
<div class="rightinfo">
  <form action="/Yshclbssb.php/Home/Index/paidan_add_cl"  name="xgmm" id="xgmm" method="post">
...
<table width="90%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="tablebg" id="table1">
  <tr>
    ...
    <td width="1028" bgcolor="#FFFFFF" class="tbval" ><input name="user" type="text" id="user" value="">
      赠送用户名 </td>
    </tr>
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF" class="tbval"><input name="sl" type="text" id="sl" value="">
      排单码数量</td>
    </tr>
  <!--微信填寫-->
</table>
