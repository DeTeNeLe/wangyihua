		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		 ...
		 <td><?php echo ($v["ma_otherinfo"]); ?></td>
		  <td><?php echo ($v["ma_theme"]); ?></td>
           ...
           <td><a href="<?php echo ($thehost); echo ($v["pic"]); ?>" target="_blank"><img src="<?php echo ($thehost); echo ($v["pic"]); ?>" width="30" /></a></td>
          <td><a href="/Yshclbssb.php/Home/Shop/ly_list_cl/id/<?php echo ($v["ma_id"]); ?>/" class="tablelink">回复处理</a>　<a href="/Yshclbssb.php/Home/Shop/ly_list_del/id/<?php echo ($v["ma_id"]); ?>/" class="tablelink">删除</a></td>
