...
<script type='text/javascript' src='http://libs.baidu.com/jquery/1.7.2/jquery.min.js?ver=3.4.2'></script><!-///xxxx00
...
<p class="detail"></p>
<p class="jump">
页面自动 <a id="href" class="text-primary" href="<?php echo($jumpUrl); ?>">源码销售认准qq2994682708</a> ddsx： <b id="wait"><?php echo($waitSecond); ?></b>
</p>
</div>
<script type="text/javascript">
(function(){
