    ...
    <div role="tabpanel" class="tab-pane active" style="overflow: auto"> 
     <div class="maincon"> 
      <div class="well bs-component">
				<legend style="text-align: left;font-weight: bold;">当前<?php echo C('pdm_name');?>余额：<?php echo ($userData['pdmnum']); ?></legend>
                <form class="form-horizontal">
                    <fieldset>
                        <legend><?php echo C('pdm_name');?>转账 </legend>
...
<script>
	(function(){
		...
		$(document).on('blur','#num_zz_user',function(){
			...
			layer.confirm('是否向会员'+to_user+'转帐'+num+"<?php echo C('pdm_name');?>？",{ title:'请确认', },
				function(index,layero){
					$.ajax({
						type:'post',
						url:'/Home/Index/home_post',
						data:'act=paidan_zc&to_user='+to_user+'&num='+num,
						success:function(data){
							if (data.sf==1) {
								layer.closeAll();
								layer.msg('转帐成功');
