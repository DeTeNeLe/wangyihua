    ...
    <div role="tabpanel" class="tab-pane active" style="overflow: auto"> 
     <div class="maincon"> 
      <div class="well bs-component">
			<legend style="text-align: left;font-weight: bold;">当前<?php echo C('jifen_wallet_name');?>余额：<?php echo ($userData['jifen']); ?></legend>
				<form class="form-horizontal" <?php if(C('cxj_dhjhm_num') == 0): ?>style="display:none"<?php endif; ?>>
                    <fieldset>
                        <legend><?php echo C('jifen_wallet_name');?>兑换<?php echo C('jhm_name');?> </legend>
                        <span class="help-block">兑换无需手续费,每<?php echo C('cxj_dhjhm_num');?>个<?php echo C('jifen_wallet_name');?>可兑换1个<?php echo C('jhm_name');?></span>
                        <div class="form-group col-lg-6 col-xs-12">
                            <div class="col-lg-8 col-xs-8">
                                <input type="text" class="form-control" id="num_zz_user" value="<?php echo ($_SESSION['uname']); ?>"
								placeholder="兑换账号或手机号" disabled="disabled">
                            </div>
                            <label for="num_zz_user" class="col-lg-4 col-xs-4 text-left control-label"></label>
                        </div>
                   		<div class="form-group col-lg-6 col-xs-12">
                            <div class="col-lg-8 col-xs-8">
                                <input type="text" class="form-control" id="num_zz_nums" placeholder="要兑换的<?php echo C('jhm_name');?>数量">
                            </div>
	...
	(function(){
		...
		$(document).on('blur','#num_zz_user',function(){
			...
			if (o<=0) {
				...
				$('[for=\'num_zz_nums\']').text('需扣除0%手续费：'+(o*0.0)+"<?php echo C('jifen_wallet_name');?>");
