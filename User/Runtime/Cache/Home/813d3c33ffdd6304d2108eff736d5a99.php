		...
		<div class="maincon">
			...
			<div class="maincon">
				<div class="orderlist out">
					<?php if($count == 0): ?><div style="color:#fff">当前没有订单</div><?php endif; ?>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><!--<div class="l_item sq out status_p_<?php echo (get_p_status($p["orderid"])); ?>" act="viewin" data="<?php echo ($p["orderid"]); ?>">
							<span class="sbj">状态</span>
							<div>
								参与者:<?php echo ($p["user"]); ?>
							</div>
							<div>
						...
						<div class="order_bar">
							...
							<p>持仓总量: <?php echo (get_tgbz_totaljb($p["mainid"])); ?>/<?php echo ($p["cc_total_num"]); ?>
								<!--<?php echo (get_pro_num(get_tgbz_totaljb($p["mainid"]))); ?>-->
							</p>
							<p>开仓积分: <?php echo ($p["kc"]); ?>/<?php echo ($p["kc_num"]); ?></p>
							<p>平仓积分: <?php echo ($p["pc"]); ?>/<?php echo ($p["pc_num"]); ?></p>
							<?php if($p["kc_zt"] == 0): ?><div style="">
								<!--撮合交易完成！请在2019-05-19 12:23:43之前交割，否则积分失效-->
								排队中
							</div><?php endif; ?>
							<?php if($p["kc_zt"] == 1 and $p["pc_zt"] == 0): ?><div style="">
									<!--撮合交易完成！请在2019-05-19 12:23:43之前交割，否则积分失效-->
									开仓已完成，平仓排队中
								</div><?php endif; ?>
							<?php if($p["kc_zt"] == 1 and $p["pc_zt"] == 1): ?><div style="">
									<!--撮合交易完成！请在2019-05-19 12:23:43之前交割，否则积分失效-->
									已完成
								</div><?php endif; ?>
					...
					<!--<div class="fixed-table-pagination " style="display: block; ">
						<div class="pull-left pagination-detail ">
							<span class="pagination-info " style="font-size: .8em;color: #fff "> (共 <?php echo ($count); ?> 条) </span>
