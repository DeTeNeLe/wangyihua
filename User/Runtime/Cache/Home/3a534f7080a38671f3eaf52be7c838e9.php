...
<style>
	...
	.content-wrapper {
		background: url('assets/img/newbg.jpg') 50% 50% repeat #000;
		background-size: contain;
	}
...
//    _MEIQIA('entId', 151672);
</script>
<div class="content-wrapper tab-content tab-addtabs" style="padding-top: 0px;">
	<div class="my_hred">
		<div class="hredimg" style="margin-top: 19px;">
			<img style="height: 7em; width: 7em;" src="/img/qin/herdimg.png" />
		</div>
		<div class="hredinfo">
			<h5><?php echo ($userData['ue_theme']); ?></h5>
			<p style="font-size: 1.8em"><?php echo ($userData['ue_account']); ?></p>
			<p style="font-size: 1.8em">等级：<span style="color:gold;"><?php echo ($userData['levelname']); ?></span></p>
		</div>
	</div>
	<div class="my_list">
		<ul style="padding: 5px;">
			<li>
				<a href="/Info/my_info/">
					<div>
						<img src="/img/qin/my_1.png"><label>我的资料</label>
					</div>
					<span>></span>
				</a>
			</li>
			<li >
				<a href="/Info/trading_record/">
					<div>
						<img src="/img/qin/my_2.png"><label>交易记录</label>
					</div>
					<span>></span>
				</a>
			</li>
			<li>
				<a href="/Info/wallet/">
					<div>
						<img src="/img/qin/my_3.png"><label>财务明细</label>
					</div>
					<span>></span>
				</a>
			</li>
			<!--<li>-->
				<!--<a href="/Info/safety/">-->
					<!--<div>-->
						<!--<img src="/img/qin/my_4.png"><label>安全中心</label>-->
					<!--</div>-->
					<!--<span>></span>-->
				<!--</a>-->
			<!--</li>-->
			<li>
				<a href="/Info/message/">
					<div>
						<img src="/img/qin/my_5.png"><label>留言反馈</label>
					</div>
					<span>></span>
				</a>
			</li>
			<li>
				<a href="/Info/about/">
					<div>
						<img src="/img/qin/my_6.png"><label>关于我们</label>
					</div>
					<span>></span>
				</a>
			</li>
			<li>
				<a href="/Login/logout/" style="border-bottom: none;">
					<div>
						<img src="/img/qin/my_7.png"><label>退出登录</label>
					</div>
					<span>></span>
				</a>
			</li>
	...
	<!--<tr>-->
	<!--<td>昵称/姓名</td>-->
	<!--&lt;!&ndash;<td><?php echo ($userData['ue_theme']); ?></td>&ndash;&gt;-->
	<!--<td><input type="text" disabled="disabled" class="form-control" name="wechat" value="<?php echo ($userData['ue_theme']); ?>" /></td>-->
	<!--</tr>-->
	<!--<tr>-->
	<!--<td>手机号</td>-->
	<!--&lt;!&ndash;<td class="user_mobile"><?php echo ($userData['ue_phone']); ?></td>&ndash;&gt;-->
	<!--<td><input type="text" disabled="disabled" class="form-control" name="wechat" value="<?php echo ($userData['ue_phone']); ?>" /></td>-->
	<!--</tr>-->
	<!--<tr>-->
	<!--<td>微信</td>-->
	...
	<!--<td>状态</td>-->
	<!--<td>-->
	<!--<?php if($userData['ue_check'] == 0 ): ?>未激活-->
	<!--<?php else: ?>激活(<?php echo ($userData['jihuo_time']); ?>)<?php endif; ?>-->
	<!--</td>-->
	<!--</tr>-->
	<!--<tr>-->
	<!--<td>注册日期</td>-->
	...
	<!--</tr>-->
	<!--</table>-->
	<!--<a class="btn btn-primary mf_edit">编辑基本信息</a>-->
	<!--<a class="btn btn-primary mf_save">保存</a>-->
	<!--</div>-->
	<!--<div class="contitle">-->
	<!--点击修改修改密码-->
	<!--</div>-->
	...
	<!--<div style="width: 80%;margin: auto;">-->
	<!--<div style="margin: 10px 0">-->
	<!--<span style="display: inline-block;width: 49%">输入原密码：</span><input type="password" class="form-control ymmsec" placeholder="原密码" style="width: 49%;display: inline-block;" />-->
	<!--</div>-->
	<!--<div style="margin: 10px 0">-->
	<!--<span style="display: inline-block;width: 49%">输入新的密码：</span><input type="password" class="form-control xmmsec" placeholder="新的密码" style="width: 49%;display: inline-block;" />-->
	<!--</div>-->
	<!--<div style="margin: 10px 0">-->
	<!--<span style="display: inline-block;width: 49%">确认新密码：</span><input type="password" class="form-control xmmqrsec" placeholder="确认新密码" style="width: 49%;display: inline-block;" />-->
	<!--</div>-->
	<!--<div>-->
	<!--<a class="btn btn-primary mf_savepwdsec">提交</a>-->
	<!--</div>-->
	<!--</div>-->
	<!--</div>-->
	...
	<!--<div style="display:none">-->
	<!--<div>-->
	<!--<span>托管开关</span> <input class="toggle" type="checkbox" id="tuoguan" <?php if($userData['tuoguan'] == 1 ): ?>checked='checked'-->
	<!--<?php else: ?>-->
	<!--<?php endif; ?> >-->
	...
	<!--<div>-->
	<!--<div class='card'>-->
	<!--<div><span class='left'>银行：</span><span>农业银行</span></div>-->
	<!--<div><span class='left'>卡号：</span><span>62284810</span></div>-->
	<!--<div><span class='left'>支行：</span><span>东台市支行</span></div>-->
	<!--<div><span class='left'>持有人：</span><span>陶丽</span></div>-->
	<!--<div><span class='left'>支付宝：</span><span>13779588</span></div>-->
	<!--<div><span class='left'>备注：</span><span></span></div>-->
	<!--</div> <span class="help-block">为了保障会员账户安全，银行卡添加后会员不可编辑或删除。如需更改银行卡请联系客服操作。</span>-->
	<!--</div>-->
	<!--</div>-->
	<!--</div>-->
	<!--</div>-->
...
<div class="footer_box">
	...
	<a href="/Info/grsz/">
		<img src="/img/qin/mine_s.png" />
		<p style="color: #3B8CFF">我的</p>
	</a>
</div>
<style>
	#settingpanel {
...
<script>
    ...
    function time(o) {
        ...
        $.post("<?php echo U('Info/sendPhone_info');?>", {
            phone: "<?php echo ($userData['ue_phone']); ?>"
        }, function(msg) {
    ...
    (function() {
        ...
        //保存二级密码
        $(document).on('click', '.mf_savepwdsec', function() {
            var ymm = $('.ymmsec').val();
            var xmm = $('.xmmsec').val();
            var xmmqr = $('.xmmqrsec').val();
            $.ajax({
                type: 'post',
                url: '/Home/Info/xgyjmmclsec',
                data: 'ymm=' + ymm + '&xmm=' + xmm + '&xmmqr=' + xmmqr,
                timeout: 7000,
                async: true,
                success: function(data) {
                    if(data.sf == 1) {
                        layer.msg('二级密码修改成功，请重新登录');
                        setTimeout(function() {
                            location.href = '/'
                        }, 1000)
                    } else {
