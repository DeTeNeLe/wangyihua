	...
	<div role="tabpanel" class="tab-pane active" style="overflow: auto">
		<div class="maincon">
			<div class="well bs-component">
				<legend style="text-align: left;font-weight: bold;color: white;">当前<?php echo C('jhm_name');?>数量：<?php echo $user_data['jhmnum'];?></legend>
				<form class="form-horizontal">
					<fieldset>
						<legend style="border: none; color: white;"><?php echo C('jhm_name');?>转让 </legend>
	...
	<div role="tabpanel" class="tab-pane active" style="overflow: auto">
		<div class="maincon">
			<div class="walletpanel">
				...
				<div>
					<?php if(is_array($jhm_list)): foreach($jhm_list as $key=>$v): ?><div class="order_bar">
			...
			layer.confirm('是否向会员' + to_user + '转帐' + num + "<?php echo C('jhm_name');?>？", {
				...
				function(index, layero) {
					$.ajax({
						type: 'post',
						url: '/Home/Index/home_post',
						data: 'act=jhm_zc&to_user=' + to_user + '&num=' + num + '&secpwd=' + secpwd,
						success: function(data) {
							if(data.sf == 1) {
								layer.closeAll();
								layer.msg('转帐成功');
