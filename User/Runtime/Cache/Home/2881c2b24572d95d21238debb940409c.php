...
<div class="content-wrapper tab-content tab-addtabs" style="padding-top: 0px;">
	<div class="tx_hred_box" style="text-align: left;    padding: 5px 0px; padding-left: 5%; padding-right: 10px; overflow: hidden;">
		<div class="div_box">
			<p><?php echo (num_to_int($userData['pdmnum'])); ?></p>
			<p style="color: #3B8CFF;  font-size: 1.5em;">通证</p>
		</div>
		<div class="div_box">
			<a href="/Info/jifen/">
				<p><?php echo (num_to_int($userData['jifen'])); ?></p>
				<p style="color: #3B8CFF; font-size: 1.5em;">诚信金</p>
			</a>
		</div>
		<div class="div_box">
			<p><?php echo (num_to_int($userData['jhmnum'])); ?></p>
			<p style="color: #3B8CFF; font-size: 1.5em;">激活码</p>
		</div>
		<p style="font-size: 1.5em; color: red; display: block; text-align: center;">交割红利：<?php echo ($all_done_total_lx); ?></p>
	</div>
	<div class="tx_function">
		<p>操作功能</p>
		<div class="tz_funtion_box">
			<a href="<?php echo ($tgurl); ?>" url="<?php echo ($tgurl); ?>">
				<img style="width: 51px; height: 51px;" src="/img/qin/token_1.png" />
				<p>帮助注册</p>
			</a>
			<a href="/Myuser/index/"> 
				<img style="width: 51px; height: 51px;" src="/img/qin/token_4.png" />
				<p>帐号归属</p>
			</a>
			<a href="/Info/transfer2/">
				<img style="width: 51px; height: 51px;" src="/img/qin/token_3.png" />
				<p>激活码转让</p>
			</a>
			<a href="/Info/paidan/">
				<img style="width: 51px; height: 51px;" src="/img/qin/token_2.png" />
				<p>通证转让</p>
			</a>
		</div>
	</div>
	<!--<div role="tabpanel" class="tab-pane active" style="overflow: auto">
		<div class="maincon">
			<div class="well bs-component">
				<legend style="text-align: left;font-weight: bold;">当前<?php echo C('jhm_name');?>余额：</legend>
...
<div class="footer_box">
	...
	<a href="/Info/jhm/">
		<img src="/img/qin/token_s.png" />
		<p style="color: #3B8CFF">通证</p>
	</a>
	<a href="/Index/help/">
...
<script>
	(function() {
		...
		$(document).on('blur', '#num_zz_user', function() {
			...
			layer.confirm('是否向会员' + to_user + '转帐' + num + "<?php echo C('jhm_name');?>？", {
					title: '请确认',
				},
