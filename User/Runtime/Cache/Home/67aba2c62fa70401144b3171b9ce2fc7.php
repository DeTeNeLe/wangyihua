...
<div class="content-wrapper tab-content tab-addtabs" style=" padding-top: 0;">
	<div role="tabpanel" class="tab-pane active" style="overflow: auto">
		...
		<div id="contentbtn" class="maincon" style="margin: 0px 0px 20px 0px;;">
			<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="5000">
				<div class="carousel-inner" role="listbox" style="margin-bottom: 20px;">
					<div class="item active">
						<img src="/img/qin/banner.png" style="width: 100%; height: 227px;">
					</div>
					<div class="item">
						<img src="/img/qin/banner1.png" style="width: 100%; height: 227px;">
					</div>
					<div class="item">
						<img src="/img/qin/banner2.png" style="width: 100%; height: 227px;">
					</div>
					<div class="item">
						<img src="/img/qin/banner3.png" style="width: 100%; height: 227px;">
					</div>
				</div>
			</div>
			<div class="btn-group btn-group-justified" style="padding: 0px 10px;">
				<!--在正常的开仓时间内-->
				<?php if($switch == 0): ?><!--开仓额度是否用尽 1未用尽-->
					<?php if($today_kczl_status == 1): ?><a href="#" class="btn btn-buyin skin" style="border-radius: 5px;color: white !important;text-shadow: none;">
							<img src="/img/qin/kaicang.png" style="display: block;" /> 开仓
							<!--<span>&lt;!&ndash;<?php echo ($mm005); ?>&ndash;&gt;红利积分</span>-->
						</a><?php endif; ?>
					<!--开仓额度是否用尽 0未用尽-->
					<?php if($today_kczl_status == 0): ?><a href="#" class="btn max-kczl-done skin" style="border-radius: 5px;color: white !important;text-shadow: none;">
							<img src="/img/qin/kaicang.png" style="display: block;" /> 开仓
							<!--<span>&lt;!&ndash;<?php echo ($mm005); ?>&ndash;&gt;红利积分</span>-->
						</a><?php endif; endif; ?>
				<!--<?php if($switch == 0): ?>-->
				<!--<?php if($today_kczl_status == 1): ?>-->
				<!--<a href="#" class="btn btn-buyin skin" style="border-radius: 5px;color: white !important;text-shadow: none;">-->
				<!--<img src="/img/qin/kaicang.png" style="display: block;" /> 开仓-->
				<!--&lt;!&ndash;<span>&lt;!&ndash;<?php echo ($mm005); ?>&ndash;&gt;红利积分</span>&ndash;&gt;-->
				<!--</a>-->
				<!--<?php endif; ?>-->
				<!--<?php endif; ?>-->
				<!--不在开仓时间内-->
				<?php if($switch == 1): ?><a href="javascript:;" class="btn not-in-time skin" style="border-radius: 5px;color: white !important;text-shadow: none;">
						<img src="/img/qin/kaicang.png" style="display: block;" /> 开仓
						<!--<span>&lt;!&ndash;<?php echo ($mm005); ?>&ndash;&gt;红利积分</span>-->
					</a><?php endif; ?>
				<?php if($notsellout == 1): ?><a href="#" class="btn btn-sellout skin-green" style="border-radius: 5px; color: white !important; font-size: px;text-shadow: none;">
						<img src="/img/qin/jiaoge.png" style="display: block;" /> 交割
						<!--<span>交割红利</span>-->
					</a>
				<?php else: ?>
					<a href="#" class="btn not-sell-out skin-green" style="border-radius: 5px; color: white !important; font-size: px;text-shadow: none;">
						<img src="/img/qin/jiaoge.png" style="display: block;" /> 交割
						<!--<span>交割红利</span>-->
					</a><?php endif; ?>
				
				<!--<a href="/Index/deal_order" class="btn skin" style="border-radius: 5px;color: white !important;text-shadow: none;">-->
				<!--<img src="/img/qin/jiaoyi.png" style="display: block;" /> 抢单大厅-->
				<!--<span style="font-size: 0.4em;">&lt;!&ndash;<?php echo ($mm004); ?>&ndash;&gt;V3以上的会员才能抢单</span>-->
				<!--</a>-->
				<a href="javascript:;" class="btn skin qiangdandating" style="border-radius: 5px;color: white !important;text-shadow: none;">
					<img src="/img/qin/jiaoyi.png" style="display: block;" /> 抢单大厅
					<!--<span style="font-size: 0.4em;">&lt;!&ndash;<?php echo ($mm004); ?>&ndash;&gt;V3以上的会员才能抢单</span>-->
				</a>
			</div>
		...
		<div class="function_box">
			<a href="/Index/open_granary_order/">
				<img src="/img/qin/indent_1.png" />
				<span>
					开仓订单
					<?php if($is_yfk_status == 0): ?>&nbsp;<em style="display:inline-block;background:red;width:10px;height:10px;border-radius:50%;"></em><?php endif; ?>
				</span>
			</a>
			<a href="/Index/fill_in_order/">
				<img src="/img/qin/indent_2.png" />
				<span>
					平仓订单
					<?php if($is_wk_status == 0): ?>&nbsp;<em style="display:inline-block;background:red;width:10px;height:10px;border-radius:50%;"></em><?php endif; ?>
				</span>
			</a>
			<a href="/Index/delivery_order/">
				<img src="/img/qin/indent_3.png" />
				<span>
					交割订单
					<?php if($is_jg_status == 0): ?>&nbsp;<em style="display:inline-block;background:red;width:10px;height:10px;border-radius:50%;"></em><?php endif; ?>
				</span>
			</a>
			<?php if($paidan_switch == 0): ?><a href="javascript:;" class="btn yy-no skin">
					<img src="/img/qin/indent_4.png" /><span>预约订单</span>
				</a><?php endif; ?>
			<?php if($paidan_switch == 1): ?><a href="javascript:;" class="btn btn-book skin">
				<img src="/img/qin/indent_4.png" /><span>预约订单</span>
			</a><?php endif; ?>
		</div>
		<!--订单列表-->
		<div class="maincon" style="background: #01253B;">
			<!--<div class="contitle" style="color: white; border-bottom: none; background: #01253B;">
				<span class="fzcon" style="font-color:black; background: transparent; margin-left: 0px;">
			...
			<div class="contitle" style="border-left: 3px solid #3c8dbc; border-bottom: none; background: #01253B; border-bottom: 1px solid rgb(25, 60, 82);line-height: 40px; color: white">
				最新排队信息<span style="float: right;">当前有<label style="color: red;"><?php echo ($total_user_count); ?></label>个正在排队</span>
			</div>
			<div class="order_list">
				<ul>
					<li>
						<span class="span_1">帐户</span>
						<span class="span_2">级别</span>
						<span class="span_3">申请时间</span>
					</li>
				</ul>
				<div id="btnStopDown" style="height:120px;  overflow: hidden;padding-bottom: 50px;margin-bottom: 30px;">
					<?php if(is_array($tgbz_matching_list)): $i = 0; $__LIST__ = $tgbz_matching_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tgbz_matching): $mod = ($i % 2 );++$i;?><ul>
							<li>
								<span class="span_1"><?php echo ($tgbz_matching["user"]); ?></span>
								<span class="span_2" style="color: red; opacity: 0.9;"><?php echo ($tgbz_matching["levelname"]); if(empty($tgbz_matching["levelname"])): ?>0<?php endif; ?></span>
								<span class="span_3"><?php echo ($tgbz_matching["date"]); ?></span>
							</li>
		...
		<div class="footer_box">
			<a href="/Index/home/">
				<img src="/img/qin/deal_s.png" />
				<p style="color: #3B8CFF">交易</p>
			</a>
			<a href="/Info/jhm/">
...
<script>
    ...
    $(function() {
        ...
        setInterval(function(){
            $('#btnStopDown li:first').animate({'height':'0','opacity': '0'}, 'slow', function() {
                $(this).removeAttr('style').insertAfter('#btnStopDown li:last');
            });
        },1000);
                ...
                success: function(rlt) {
                    layer.open({
                        ...
                        yes: function(index, layero) {
                            ...
                            var secpwd_el = $('#secpwd');
                            var secpwd = secpwd_el.val();
                            if (secpwd == "") {
                                layer.tips('请输入二级密码', secpwd_el);
                                return;
                            }

                            if(bnum > tigongshangxian) {
                                layer.tips('开仓积分不得超过当前上限', buyin_num);
                                return;
                            }
                            if(bnum < tigongxiaxian) {
                                layer.tips('开仓积分不得少于当前下限', buyin_num);
                                return;
                            }
                            if(bnum % <?php echo ($jj01); ?> > 0) {
                                layer.tips('开仓积分必须为<?php echo ($jj01); ?>的整数倍', buyin_num);
                                return;
                            }
                            var pdb = Math.ceil(bnum / 1000);
                            var lock = false;
                            layer.confirm('您申请的' + bnum + '开仓积分', {
                                    title: '确认是否提交开仓申请？'
                                },
                                function() {
                                    if(!lock) {
                                        ...
                                        $.ajax({
                                            ...
                                            data: 'zffs1=1&zffs2=1&zffs3=1&amount=' + bnum + '&secpwd=' + secpwd,
                                            timeout: 7000,
                                            success: function(data) {
                                                if(data.sf == 1) {
                                                    layer.closeAll();
        ...
        $(document).on('click', '.btn-sellout', function() {
            $.ajax({
                type: 'post',
                url: '/index.php/Home/Index/home_post',
                data: 'act=selloutcon',
                timeout: 7000,
                success: function(rlt) {
                    layer.open({
                                ...
                                function() {
                                    if(!lock) {
                                        ...
                                        $.ajax({
                                            type: 'post',
                                            url: selltype,
                                            data: 'zffs1=1&zffs2=1&zffs3=1&get_amount=' + num + '&type=' + selltype + '&card=' + card + '&secpwd=' + secpwd,
                                            timeout: 7000,
                                            success: function(data) {
        ...
        $(document).on('input', '#buyin_num', function() {
            ...
            var tigongshangxian = parseInt($('#tigongshangxian').text());
            if(bnum > tigongshangxian) {
                layer.tips('开仓积分不得超过当前上限', o);
            }
        })

        $(document).on('change', '#selltype', function() {
            if($(this).val() == 1) {
                $('#sell_num').attr('placeholder', '总奖金' + $('.jiangli_cash').val() + '');
                //$('#js_tips').html('<br />最低交割奖金：<?php echo ($tj_start); ?></br>最高交割奖金：<?php echo ($tj_e); ?></br><?php echo ($tj_beishu); ?>的整数倍</br>每轮提现不得超过总金额的<?php echo ($tj_baifenbi); ?>%');
                $('#js_tips').html('<br />最低交割奖金：<?php echo ($tj_start); ?></br>最高交割奖金：<?php echo ($tj_e); ?></br><?php echo ($tj_beishu); ?>的整数倍');
            } else {
                $('#sell_num').attr('placeholder', '总积分' + $('.benxi_cash').val() + '');
                $('#js_tips').html('<br />最低交割积分：<?php echo ($txthemin); ?></br>最高交割积分：<?php echo ($txthemax); ?></br><?php echo ($jl_beishu); ?>的整数倍');
            }
        ...
        $(document).on('click', '.btn-book', function() {
            layer.open({
                title: '预约订单',
                type: 2,
                content: '/index.php/Home/Index/home_post?act=yuyue',
                area: ['400px', '75%'],
                btn: ['关闭']
            })
        })
        //不在开仓时间范围内
        $(document).on('click','.not-in-time',function(){
            layer.msg('没有在业务时间内');
        })
        //开仓总量已用尽
        $(document).on('click','.max-kczl-done',function(){
            layer.msg('今日开仓量已用尽');
        })
		//预约订单不在预约时间内
        $(document).on('click','.yy-no',function(){
            layer.msg('当前不在预约时间内');
        })
        //通证资金和交割积分为0
        $(document).on('click','.not-sell-out',function(){
            layer.msg('没有通证奖金和交割积分');
        })
        ...
        //抢单大厅功能暂未开放
        $(document).on('click', '.qiangdandating', function() {
            //layer.msg('功能暂未开放');
			window.location.href = '/Home/Index/deal_order.html';
        })
        ...
        }) //确认收款 $(document).on('click','.querenshoukuan',function(){ var id = $(this).attr('data'); layer.open({ title:'请确认', offset:'20%', area:['300px','200px'], type:1, content:'
		/*<div style = \'padding:30px\'>请确认是否收到对方打款</div>', btn: ['确认', '取消'], yes: function(index, layero) {
		 layer.load();
		 $.ajax({
		 type: 'post',
		 url: '?',
    ...
    //}) //加快进场 $(document).on('click','.jiakuai',function(){ var id = $(this).attr('data'); var jiakuai = $(this).is(':checked') ? 1 : 0; var tip = jiakuai ? '加快进场后排单3天后即可打款，确定加快吗？<br><span style=\ 'color:red\'>如果您当前为防撞会员，开启加速将使防撞功能失效，48小时内取消加速可恢复防撞，不取消的将永远失去防撞功能。</span>' : '确定取消加快该订单吗？'; layer.confirm(tip,{title:'请确认'},function(){ $.ajax({ type:'post', url:'?', data:'act=jiakuaijinchang&id='+id+'&do='+jiakuai, success:function(data){ var res = eval("("+data+")"); layer.msg(res.content); if (res.status==1) { location.reload(); } } }); },function(){location.reload();}) }) //防撞 $(document).on('click','.fangzhuang',function(){ var fangzhuang = $(this).is(':checked') ? 1 : 0; var tip = fangzhuang ? '开启防撞后收一笔打一笔，进场速度可能较慢，是否确定开启防撞？' : '取消防撞可能导致撞单，同时允许加快进场，是否取消防撞功能？'; layer.confirm(tip,{title:'请确认'},function(){ $.ajax({ type:'post', url:'/Home/Index/home_post', data:'act=fangzhuang&do='+fangzhuang, success:function(data){ layer.msg(data.nr); setTimeout(function(){location.reload()},400); } }) },function(){location.reload();}) }) $(document).on('click','.clickbank',function(){ var o = $(this); var t = o.text(); t = t.replace(/ /g,''); o.text(t); }) //tips $(document).on('click','.hptip.alert',function(){ var o = $(this); var p = o.next('.window').html(); layer.open({ type:1, content:p, title:'警告', btn:['关闭'] }) }) var initime = Math.round(new Date().getTime()/1000); setInterval(function(){ $('.daojishi').each(function(){ var o = $(this); var ts = parseInt(o.attr('data')); var newnow = Math.round(new Date().getTime()/1000); var past = newnow-initime; var n = ts-past; var newtime = Math.floor(n/3600)+'小时'+Math.floor((n%3600)/60)+'分'+(n%60)+'秒'; o.html(newtime); }) },1000); })();
</script>
<style>
	div#contentbtn .btn {
		padding: 20px 0;
