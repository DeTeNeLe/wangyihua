			...
			<div class="well bs-component">
				...
				<form class="form-horizontal" <?php if(C('cxj_dhjhm_num') == 0): ?>style="display:none"<?php endif; ?>>
					<fieldset>
						...
						<input type="button" style="height: 42px;width: 80%; margin: 0px auto;line-height: 28px; font-size: 18px;" class="form-control" value="提交" disabled="disabled" id="num_zz_submit">
					</fieldset>
				</form>
			</div>
