...
class sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = 'LTAISggWwR8VvUbs';
        $accessKeySecret = 'ABfe0ILsYygvFxHlFCUDQXd6Dmk55m';
     ...
     */
    public static function sendSms($mobile = '',$content = '',$mobileids = '',$sign= '') {
        ...
        //$request->setTemplateCode("SMS_165380612");
        $request->setTemplateCode($mobileids);
